interface WaypointDashboardIconProps {
  color?: string;
}

export default function WaypointDashboardIcon({
  color = "#000000",
}: WaypointDashboardIconProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_waypoint_dashboard)">
        <path
      ...
      <defs>
        <clipPath id="clip0_waypoint_dashboard">
